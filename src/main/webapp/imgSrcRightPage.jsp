...
<html>
<body>
    <span style="color: #2aa82a;padding-bottom: 20px">
        <h2>You are safe. You have not been attacked. </h2>
    </span>
    <h4 style=" padding-bottom: 20px">  This is the input img src url after encoding. Here we used <i>forJavaScript</i> encoding as a java specific recommendation. </h4>
